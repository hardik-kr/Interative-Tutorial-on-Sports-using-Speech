...
void CLRproj1::India::speak(string str)
{
	if (str == "India") {
		while (1) {
			...
			/*int index = hmm.start("Record_Module\\Voice\\test.txt", "Sports\\Cricket\\India\\Modelpara\\finalA.txt",
				"Sports\\Cricket\\India\\Modelpara\\finalB.txt", "Sports\\Cricket\\India\\Modelpara\\finalPI.txt",
				"Sports\\Cricket\\India\\Modelpara\\codebook.txt", levelsize);*/
			int index = 0;
			if (index == -1) {
